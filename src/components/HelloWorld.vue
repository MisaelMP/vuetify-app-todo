...
<v-app>
    ...
    <h1 class="footer__title">Hello world</h1>
    <figure class="footer__container">
        <img class="footer__image" src="https://source.unsplash.com/random" alt="">
    </figure>
</v-app>
</template>
